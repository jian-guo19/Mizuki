...
export const siteConfig: SiteConfig = {
	...
	bilibili: {
		vmid: "66283513032", // 在此处设置你的Bilibili用户ID (uid)，例如 "1129280784"
	...
	banner: {
		...
		homeText: {
			...
			title: "ACG避风港", // 主页横幅主标题

			subtitle: [
				"虽然没有什么特别的事，但只要有你在就足够了", 
				"直到现在你依然是我的光", 
				"你啊，不知不觉间已经成为我每天的一部分了", 
				"和你聊天，总觉得每天都会变得稍微开心一点", 
				"今天是个平淡无奇的日子。不过，也是稍微美好的一天"
			],
			typewriter: {
...
export const profileConfig: ProfileConfig = {
	avatar: "assets/images/Wall-nut.jpg", // 相对于 /src 目录。如果以 '/' 开头，则相对于 /public 目录
	name: "坚果杜",
	bio: "世界很大，你必须去看看",
	typewriter: {
